...
<head>
  ...
  <link rel="stylesheet" href="../../css/mine/m-notSend.css">
  <title>未发布</title>
</head>
    ...
    <div class="content-sort">
      <ul>
        ...
        <li class="type-select-input">
          <span>其他选项：</span>
          <div class="input-sel">
            <span style="display:none;">用户：</span>
            <input style="display:none;" type="text" class="input-text" placeholder="不限">
            <span>创建时间：</span>
...
<script type="text/html" id="table_tpl">
  ...
  <tr>
    ...
    <td>
      ...
      <span>|</span>
      <a href="javascript:;" data-id="2" data-type={{v.data_type}} data-n_id={{v.n_id}}>删除</a>
    </td>
  </tr>
  {{/each}}
</script>
...
<script src="../../js/mine/m-notSend.js"></script>
